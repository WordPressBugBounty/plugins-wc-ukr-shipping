...
<?php echo View::render('partial/settings_top', ['section' => 'ukrposhta']); ?>
        ...
        <div id="wc-ukr-shipping-settings" class="wcus-settings wcus-settings--full">
            ...
            <div class="wcus-settings__content">
                <form id="wc-ukr-shipping-settings-form" action="/" method="POST">
                    <ul class="wcus-tabs">
                        <li data-pane="wcus-pane-parcels" class="active"><?php esc_html_e('Shipping label', 'wc-ukr-shipping'); ?></li>
                    </ul>
                    <?php echo View::render('partial/settings_ukrposhta/parcels', [
