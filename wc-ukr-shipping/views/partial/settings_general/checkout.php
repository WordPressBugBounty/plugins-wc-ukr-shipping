...
<div id="wcus-pane-checkout" class="wcus-tab-pane">
    ...
    <?php
        HtmlHelper::selectField(
            ...
            __('Load translates from', 'wc-ukr-shipping'),
            [
                '0' => __('Plugin settings', 'wc-ukr-shipping'),
                '1' => __('Wordpress localization files', 'wc-ukr-shipping'),
            ],
            wc_ukr_shipping_get_option('wc_ukr_shipping_np_translates_type'),
            __('If you are using language plugins such as WPML or Polylang - select "Wordpress localization files" option', 'wc-ukr-shipping')
        );
