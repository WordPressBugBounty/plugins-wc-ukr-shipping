...
<div id="wcus-pane-parcels" class="wcus-tab-pane">
    ...
    <div class="wcus-form-group">
        <label for="wcus_ttn_description"><?= __('Default description', 'wc-ukr-shipping'); ?></label>
    ...
    <?php
        HtmlHelper::textField(
            ...
            __('Default weight', 'wc-ukr-shipping'),
            wc_ukr_shipping_get_option('wcus_ttn_weight_default')
        );
    ?>

    <div class="wcus-control-group">
        <div class="wcus-control-group__title"><?php esc_html_e('Default dimensions', 'wc-ukr-shipping'); ?></div>
        <div class="wcus-control-group__content">
            <div class="wcus-row">
                <div class="wcus-col-md-2">
                    <div class="wcus-form-group">
                        <label for="wcus_ttn_width_default"><?= __('Width (cm)', 'wc-ukr-shipping'); ?></label>
                        <input type="text"
                ...
                <div class="wcus-col-md-2">
                    <div class="wcus-form-group">
                        <label for="wcus_ttn_height_default"><?= __('Height (cm)', 'wc-ukr-shipping'); ?></label>
                        <input type="text"
                ...
                <div class="wcus-col-md-2">
                    <div class="wcus-form-group">
                        <label for="wcus_ttn_length_default"><?= __('Length (cm)', 'wc-ukr-shipping'); ?></label>
                        <input type="text"
