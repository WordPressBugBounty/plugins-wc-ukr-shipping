...
<div id="wcus-pane-checkout" class="wcus-tab-pane active">
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_lang"><?= __('Display language of cities and departments', 'wc-ukr-shipping'); ?></label>
        <select id="wc_ukr_shipping_np_lang"
                name="wc_ukr_shipping[np_lang]"
                class="wcus-form-control">
            <option value="ru" <?= get_option('wc_ukr_shipping_np_lang', 'uk') === 'ru' ? 'selected' : ''; ?>><?= __('Russian', 'wc-ukr-shipping'); ?></option>
            <option value="uk" <?= get_option('wc_ukr_shipping_np_lang', 'uk') === 'uk' ? 'selected' : ''; ?>><?= __('Ukrainian', 'wc-ukr-shipping'); ?></option>
        </select>
    </div>
