...
<div id="wcus-pane-translates" class="wcus-tab-pane">
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_method_title"><?= __('Shipping method name', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_block_title"><?= __('Shipping block title', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_placeholder_area"><?= __('Placeholder of select area field', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_placeholder_city"><?= __('Placeholder of select city field', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_placeholder_warehouse"><?= __('Placeholder of select warehouse field', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_address_title"><?= __('Label of address selector', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_address_placeholder"><?= __('Placeholder of address field', 'wc-ukr-shipping-i18n'); ?></label>
    ...
    <div class="wcus-form-group">
        <label for="wc_ukr_shipping_np_not_found_text"><?= __('Empty result text', 'wc-ukr-shipping-i18n'); ?></label>
