...
namespace kirillbdev\WCUkrShipping\Component\Carriers\InPost\Order;
...
class CheckoutOrderHandler implements OrderHandlerInterface
{
    ...
    {
        return [
            'meta._wcus_pudo_point_name' => $data['wcus_inpost_' . $this->fieldGroup . '_pudo_name'] ?? '',
            'shippingMeta.wcus_pudo_point_id' => $data['wcus_inpost_' . $this->fieldGroup . '_pudo_id'] ?? '',
            'shippingMeta.wcus_pudo_point_name' => $data['wcus_inpost_' . $this->fieldGroup . '_pudo_name'] ?? '',
        ];
    }
