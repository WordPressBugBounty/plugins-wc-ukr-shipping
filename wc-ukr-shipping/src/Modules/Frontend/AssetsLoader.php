...
class AssetsLoader implements ModuleInterface
{
    ...
    private function injectGlobals()
    {
        ...
        $globals['i18n'] = [
            ...
            'shipping_type_warehouse_poshtomat' => __('To warehouse or poshtomat', 'wc-ukr-shipping'),
            'ui' => [
                ...
                'text_search' => __('Enter 3 or more characters to search', 'wc-ukr-shipping'),
                'text_search_warehouse' => __('Enter number or address of warehouse', 'wc-ukr-shipping'),
                'text_loading' => __('Loading...', 'wc-ukr-shipping'),
                'text_more' => __('Load more', 'wc-ukr-shipping'),
                'text_not_found' => __('Nothing found', 'wc-ukr-shipping'),
                'text_more_chars' => __('Enter more chars', 'wc-ukr-shipping'),
                'settlement_placeholder' => __('Select locality', 'wc-ukr-shipping'),
                'street_placeholder' => __('Select street', 'wc-ukr-shipping'),
